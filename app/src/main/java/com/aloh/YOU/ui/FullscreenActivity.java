...
public class FullscreenActivity extends Activity {
    ...
    final Context context= FullscreenActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (c.moveToFirst()) {
            ...
            Call<ResponseBody> call = callback.getSaldo(c.getString(0).toString(),c.getString(1).toString());
            call.enqueue(new Callback<ResponseBody>() {
                @Override
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    try {
                        String saldo = response.body().string().toString();
                        if(saldo.equals("s")){
                            db.cleanUsuario();
                            db.close();
                            ...
                            i.putExtra("USUARIO",c.getString(0).toString());
                            startActivity(i);
                            finish();
                        }
                    } catch (IOException e) {
